...
public class BenefitController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		ArrayList<WebPromotionVO> weblist=ReservationController.getWebPromotionvolist();
		ArrayList<HotelPromotionVO> hotelprolist=ReservationController.getHotelprolist();
